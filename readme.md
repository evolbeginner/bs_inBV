...
- [`newick-utils`](https://github.com/tjunier/newick_utils)  
  If compiling from source is problematic, download the pre-compiled binaries of Newick Utilities v1.6 from  
  <https://web.archive.org/web/20210409163921/http://cegg.unige.ch/pub/newick-utils-1.6-Linux-x86_64-disabled-extra.tar.gz>.
